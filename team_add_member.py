...
results = requests.post(base_url + "teams/" + team_id + "/relationships/organization-memberships", headers=org_headers, data=body)
if results.status_code == 204:
    print("User " + team_member_email + " added to team " + team_name)
else:
